# Panel de Administración (Spring Boot Admin) - SWDB 2026

Este repositorio contiene el microservicio de **Panel de Administración (Spring Boot Admin)** como un componente independiente del ecosistema SWDB 2026.
...
mvn spring-boot:run
```
*El servicio se desplegará localmente escuchando en el puerto `9090`.*
